 ...
 * @since 1.0.0
 */
class BQW_Grid_Accordion_Lite_Updates {
	...
	public function __construct() {
		...
		if ( version_compare( $this->db_version, BQW_Grid_Accordion_Lite::VERSION, '>=' ) ) {
			return;
		}
	...
	private function single_update() {
		update_option( 'grid_accordion_version', BQW_Grid_Accordion_Lite::VERSION );
	}
}